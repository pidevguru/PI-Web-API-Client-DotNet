...
{
	public class AnalysisCategoryControllerClient
	{
		private HttpApiClient httpApiClient;
		public AnalysisCategoryControllerClient(HttpApiClient httpApiClient)
		{
		...
		/// <param name="path">The path to the target analysis category.</param>
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisCategory></returns>
		public async Task<HttpApiResponse<PWAAnalysisCategory>> GetByPathWithHttpAsync(string path, string selectedFields = null, string webIdType = null)
		{
			if (path == null)
			{
			...
			string serviceUrl = "/analysiscategories";
			...
			PWAAnalysisCategory response = JsonConvert.DeserializeObject<PWAAnalysisCategory>(httpContent);
			return new HttpApiResponse<PWAAnalysisCategory>(httpStatusCode, httpResponse.Headers.ToDictionary(x => x.Key, x => x.Value.First().ToString()), response);
		}
		...
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisCategory</returns>
		public async Task<PWAAnalysisCategory> GetByPathAsync(string path, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisCategory></returns>
		public HttpApiResponse<PWAAnalysisCategory> GetByPathWithHttp(string path, string selectedFields = null, string webIdType = null)
		{
			if (path == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'path'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisCategory</returns>
		public PWAAnalysisCategory GetByPath(string path, string selectedFields = null, string webIdType = null)
		{
		...
		/// </remarks>
		/// <exception cref="PIDevGuru.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the analysis category to delete.</param>
		...
		public async Task<HttpApiResponse<object>> DeleteWithHttpAsync(string webId)
		{
			...
			string serviceUrl = "/analysiscategories/{webId}";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
		...
		/// </remarks>
		/// <exception cref="PIDevGuru.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the analysis category.</param>
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisCategory></returns>
		public async Task<HttpApiResponse<PWAAnalysisCategory>> GetWithHttpAsync(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisCategory</returns>
		public async Task<PWAAnalysisCategory> GetAsync(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisCategory></returns>
		public HttpApiResponse<PWAAnalysisCategory> GetWithHttp(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisCategory</returns>
		public PWAAnalysisCategory Get(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// </remarks>
		/// <exception cref="PIDevGuru.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the analysis category to update.</param>
		/// <param name="category">A partial analysis category containing the desired changes.</param>
		/// <returns>HttpApiResponse<object></returns>
		public async Task<HttpApiResponse<object>> UpdateWithHttpAsync(string webId, PWAAnalysisCategory category)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="category">A partial analysis category containing the desired changes.</param>
		/// <returns>object</returns>
		public async Task<object> UpdateAsync(string webId, PWAAnalysisCategory category)
		{
		...
		/// <param name="category">A partial analysis category containing the desired changes.</param>
		/// <returns>HttpApiResponse<object></returns>
		public HttpApiResponse<object> UpdateWithHttp(string webId, PWAAnalysisCategory category)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="category">A partial analysis category containing the desired changes.</param>
		/// <returns>object</returns>
		public object Update(string webId, PWAAnalysisCategory category)
		{
		...
		/// </remarks>
		/// <exception cref="PIDevGuru.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the analysis category for the security to be checked.</param>
		...
		public async Task<HttpApiResponse<PWAItemsSecurityRights>> GetSecurityWithHttpAsync(string webId, List<string> userIdentity, bool? forceRefresh = null, string selectedFields = null, string webIdType = null)
		{
			...
			string serviceUrl = "/analysiscategories/{webId}/security";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddPathParameter("webId", webId);
		...
		public async Task<HttpApiResponse<PWAItemsSecurityEntry>> GetSecurityEntriesWithHttpAsync(string webId, string nameFilter = null, string selectedFields = null, string webIdType = null)
		{
			...
			string serviceUrl = "/analysiscategories/{webId}/securityentries";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddPathParameter("webId", webId);
		...
		/// </remarks>
		/// <exception cref="PIDevGuru.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the analysis category, where the security entry will be created.</param>
		...
		/// <param name="webId">The ID of the analysis category, where the security entry will be deleted.</param>
		/// <param name="applyToChildren">If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.</param>
		/// <returns>HttpApiResponse<object></returns>
		public async Task<HttpApiResponse<object>> DeleteSecurityEntryWithHttpAsync(string name, string webId, bool? applyToChildren = null)
		{
			...
			string serviceUrl = "/analysiscategories/{webId}/securityentries/{name}";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
		...
		/// <param name="webId">The ID of the analysis category, where the security entry will be updated.</param>
