...
{
	public class NotificationContactTemplateControllerClient
	{
		private HttpApiClient httpApiClient;
		public NotificationContactTemplateControllerClient(HttpApiClient httpApiClient)
		{
		...
		/// <param name="path">The path to the notification contact template.</param>
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWANotificationContactTemplate></returns>
		public async Task<HttpApiResponse<PWANotificationContactTemplate>> GetByPathWithHttpAsync(string path, string selectedFields = null, string webIdType = null)
		{
			if (path == null)
			{
			...
			string serviceUrl = "/notificationcontacttemplates";
			...
			PWANotificationContactTemplate response = JsonConvert.DeserializeObject<PWANotificationContactTemplate>(httpContent);
			return new HttpApiResponse<PWANotificationContactTemplate>(httpStatusCode, httpResponse.Headers.ToDictionary(x => x.Key, x => x.Value.First().ToString()), response);
		}
		...
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWANotificationContactTemplate</returns>
		public async Task<PWANotificationContactTemplate> GetByPathAsync(string path, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWANotificationContactTemplate></returns>
		public HttpApiResponse<PWANotificationContactTemplate> GetByPathWithHttp(string path, string selectedFields = null, string webIdType = null)
		{
			if (path == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'path'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWANotificationContactTemplate</returns>
		public PWANotificationContactTemplate GetByPath(string path, string selectedFields = null, string webIdType = null)
		{
		...
		/// </remarks>
		/// <exception cref="TimeLordGeek.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="assetServerWebId">The ID of the asset server to use as the root of the query.</param>
		/// <param name="maxCount">The maximum number of objects to be returned per call (page size). The default is 1000.</param>
		/// <param name="query">The query string is a list of filters used to perform an AFSearch for the Notification Contact Templates in the asset database. An example would be: "query=Name:='MyNotificationContactTemplate'".</param>
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		...
		public async Task<HttpApiResponse<PWAItemsNotificationContactTemplate>> GetNotificationContactTemplatesQueryWithHttpAsync(string assetServerWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null)
		{
			string serviceUrl = "/notificationcontacttemplates/search";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddQueryParameter("assetServerWebId", assetServerWebId);
		...
		public async Task<PWAItemsNotificationContactTemplate> GetNotificationContactTemplatesQueryAsync(string assetServerWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null)
		{
			return (await this.GetNotificationContactTemplatesQueryWithHttpAsync(assetServerWebId, maxCount, query, selectedFields, startIndex, webIdType)).Data;
		}
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAItemsNotificationContactTemplate></returns>
		public HttpApiResponse<PWAItemsNotificationContactTemplate> GetNotificationContactTemplatesQueryWithHttp(string assetServerWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null)
		{
			string serviceUrl = "/notificationcontacttemplates/search";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddQueryParameter("assetServerWebId", assetServerWebId);
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAItemsNotificationContactTemplate</returns>
		public PWAItemsNotificationContactTemplate GetNotificationContactTemplatesQuery(string assetServerWebId = null, int? maxCount = null, string query = null, string selectedFields = null, int? startIndex = null, string webIdType = null)
		{
			return (this.GetNotificationContactTemplatesQueryWithHttp(assetServerWebId, maxCount, query, selectedFields, startIndex, webIdType)).Data;
		}
		...
		/// </remarks>
		/// <exception cref="TimeLordGeek.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the notification contact template to be deleted.</param>
		...
		public async Task<HttpApiResponse<object>> DeleteWithHttpAsync(string webId)
		{
			...
			string serviceUrl = "/notificationcontacttemplates/{webId}";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
		...
		/// </remarks>
		/// <exception cref="TimeLordGeek.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the notification contact template.</param>
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWANotificationContactTemplate></returns>
		public async Task<HttpApiResponse<PWANotificationContactTemplate>> GetWithHttpAsync(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWANotificationContactTemplate</returns>
		public async Task<PWANotificationContactTemplate> GetAsync(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWANotificationContactTemplate></returns>
		public HttpApiResponse<PWANotificationContactTemplate> GetWithHttp(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWANotificationContactTemplate</returns>
		public PWANotificationContactTemplate Get(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// </remarks>
		/// <exception cref="TimeLordGeek.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the notification contact template to update.</param>
		/// <param name="notificationContactTemplate">A partial notification contact template containing the desired changes.</param>
		/// <returns>HttpApiResponse<object></returns>
		public async Task<HttpApiResponse<object>> UpdateWithHttpAsync(string webId, PWANotificationContactTemplate notificationContactTemplate)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="notificationContactTemplate">A partial notification contact template containing the desired changes.</param>
		/// <returns>object</returns>
		public async Task<object> UpdateAsync(string webId, PWANotificationContactTemplate notificationContactTemplate)
		{
			return (await this.UpdateWithHttpAsync(webId, notificationContactTemplate)).Data;
		}
		...
		/// <param name="notificationContactTemplate">A partial notification contact template containing the desired changes.</param>
		/// <returns>HttpApiResponse<object></returns>
		public HttpApiResponse<object> UpdateWithHttp(string webId, PWANotificationContactTemplate notificationContactTemplate)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="notificationContactTemplate">A partial notification contact template containing the desired changes.</param>
		/// <returns>object</returns>
		public object Update(string webId, PWANotificationContactTemplate notificationContactTemplate)
		{
			return (this.UpdateWithHttp(webId, notificationContactTemplate)).Data;
		}
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWANotificationContactTemplate></returns>
		public async Task<HttpApiResponse<PWANotificationContactTemplate>> GetNotificationContactTemplatesWithHttpAsync(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
			...
			string serviceUrl = "/notificationcontacttemplates/{webId}/notificationcontacttemplates";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddPathParameter("webId", webId);
			urlBuilder.AddQueryParameter("selectedFields", selectedFields);
			urlBuilder.AddQueryParameter("webIdType", webIdType);
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWANotificationContactTemplate</returns>
		public async Task<PWANotificationContactTemplate> GetNotificationContactTemplatesAsync(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWANotificationContactTemplate></returns>
		public HttpApiResponse<PWANotificationContactTemplate> GetNotificationContactTemplatesWithHttp(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWANotificationContactTemplate</returns>
		public PWANotificationContactTemplate GetNotificationContactTemplates(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// </remarks>
		/// <exception cref="TimeLordGeek.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the notification contact template for the security to be checked.</param>
		...
		public async Task<HttpApiResponse<PWAItemsSecurityRights>> GetSecurityWithHttpAsync(string webId, List<string> userIdentity, bool? forceRefresh = null, string selectedFields = null, string webIdType = null)
		{
			...
			string serviceUrl = "/notificationcontacttemplates/{webId}/security";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddPathParameter("webId", webId);
		...
		public async Task<HttpApiResponse<PWAItemsSecurityEntry>> GetSecurityEntriesWithHttpAsync(string webId, string nameFilter = null, string selectedFields = null, string webIdType = null)
		{
			...
			string serviceUrl = "/notificationcontacttemplates/{webId}/securityentries";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
			urlBuilder.AddPathParameter("webId", webId);
		...
		/// </remarks>
		/// <exception cref="TimeLordGeek.PIWebApiClient.Exceptions.HttpApiException">Thrown when fails to make API call</exception>
		/// <param name="webId">The ID of the notification contact template, where the security entry will be created.</param>
		...
		/// <param name="webId">The ID of the notification contact template, where the security entry will be deleted.</param>
		/// <param name="applyToChildren">If false, the new access permissions are only applied to the associated object. If true, the access permissions of children with any parent-child reference types will change when the permissions on the primary parent change.</param>
		/// <returns>HttpApiResponse<object></returns>
		public async Task<HttpApiResponse<object>> DeleteSecurityEntryWithHttpAsync(string name, string webId, bool? applyToChildren = null)
		{
			...
			string serviceUrl = "/notificationcontacttemplates/{webId}/securityentries/{name}";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
		...
		/// <param name="webId">The ID of the notification contact template, where the security entry will be updated.</param>
