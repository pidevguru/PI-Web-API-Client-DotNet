...
{
	public class AnalysisRulePlugInControllerClient
	{
		private HttpApiClient httpApiClient;
		public AnalysisRulePlugInControllerClient(HttpApiClient httpApiClient)
		{
		...
		/// <returns>HttpApiResponse<PWAAnalysisRulePlugIn></returns>
		public async Task<HttpApiResponse<PWAAnalysisRulePlugIn>> GetByPathWithHttpAsync(string path, string selectedFields = null, string webIdType = null)
		{
			if (path == null)
			{
			...
			string serviceUrl = "/analysisruleplugins";
			...
			PWAAnalysisRulePlugIn response = JsonConvert.DeserializeObject<PWAAnalysisRulePlugIn>(httpContent);
			return new HttpApiResponse<PWAAnalysisRulePlugIn>(httpStatusCode, httpResponse.Headers.ToDictionary(x => x.Key, x => x.Value.First().ToString()), response);
		}
		...
		/// <param name="selectedFields">List of fields to be returned in the response, separated by semicolons (;). If this parameter is not specified, all available fields will be returned.</param>
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisRulePlugIn</returns>
		public async Task<PWAAnalysisRulePlugIn> GetByPathAsync(string path, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisRulePlugIn></returns>
		public HttpApiResponse<PWAAnalysisRulePlugIn> GetByPathWithHttp(string path, string selectedFields = null, string webIdType = null)
		{
			if (path == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'path'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisRulePlugIn</returns>
		public PWAAnalysisRulePlugIn GetByPath(string path, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisRulePlugIn></returns>
		public async Task<HttpApiResponse<PWAAnalysisRulePlugIn>> GetWithHttpAsync(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
			...
			string serviceUrl = "/analysisruleplugins/{webId}";
			UrlBuilder urlBuilder = new UrlBuilder(serviceUrl);
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisRulePlugIn</returns>
		public async Task<PWAAnalysisRulePlugIn> GetAsync(string webId, string selectedFields = null, string webIdType = null)
		{
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>HttpApiResponse<PWAAnalysisRulePlugIn></returns>
		public HttpApiResponse<PWAAnalysisRulePlugIn> GetWithHttp(string webId, string selectedFields = null, string webIdType = null)
		{
			if (webId == null)
			{
				throw new HttpApiException(400, "Missing required parameter 'webId'");
		...
		/// <param name="webIdType">Optional parameter. Used to specify the type of WebID. Useful for URL brevity and other special cases. Default is the value of the configuration item "WebIDType".</param>
		/// <returns>PWAAnalysisRulePlugIn</returns>
		public PWAAnalysisRulePlugIn Get(string webId, string selectedFields = null, string webIdType = null)
		{
