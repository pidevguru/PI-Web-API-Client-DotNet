...
namespace PIDevGuru.PIWebApiClient.Models
{
	...
	/// </summary>
	[DataContract]
	public class PWAAnalysisLinks
	{
		public PWAAnalysisLinks(string AnalysisRule = null, string AnalysisRulePlugIn = null, string Categories = null, string Database = null, string Security = null, string SecurityEntries = null, string Self = null, string Target = null, string Template = null, string TimeRule = null, string TimeRulePlugIn = null)
		{
