...
namespace PIDevGuru.PIWebApiClient.Models
{
	...
	/// </summary>
	[DataContract]
	public class PWAAnalysisCategoryLinks
	{
		public PWAAnalysisCategoryLinks(string Database = null, string Security = null, string SecurityEntries = null, string Self = null)
		{
