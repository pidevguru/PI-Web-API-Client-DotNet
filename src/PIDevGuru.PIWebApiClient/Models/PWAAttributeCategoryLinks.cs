...
namespace PIDevGuru.PIWebApiClient.Models
{
	...
	/// </summary>
	[DataContract]
	public class PWAAttributeCategoryLinks
	{
		public PWAAttributeCategoryLinks(string Database = null, string Security = null, string SecurityEntries = null, string Self = null)
		{
